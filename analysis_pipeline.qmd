...
```{r}
db_args <- list(
	"host" = "wordbank2-prod-20240205.canyiscnpddk.us-west-2.rds.amazonaws.com",
	"dbname" = "wordbank",
...
df_all_fix <- df_all_fix |> 
  bind_cols(poly(df_all_fix$ses, degree = 5) |> 
              as_tibble() |> 
